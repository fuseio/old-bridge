...
import { getCurrencySymbol, isArrayEmpty } from '../../utils'
import { filterZeroBalance } from '../../modals/SearchModal/filtering'
...
function Balance({ balance }: { balance: CurrencyAmount<Currency> }) {
  return (
    <StyledBalanceText title={balance.toExact()}>
      <TYPE.small>{balance.toSignificant(4)}</TYPE.small>
    </StyledBalanceText>
  )
}
...
function CurrencyRow({
  ...
  return (
    ...
    >
      ...
      <Column>
        <TYPE.main title={currency.name} fontWeight={500}>
...
export default function CurrencyList({
  ...
  const itemData = filteredCurrencies
