...
import { Token, ChainId } from '@voltage-finance/sdk-core'
...
import {
  ...
  updateUserAutoSlippageMode as updateUserAutoSlippageModeAction,
} from './actions'
...
export function useUserActionHandlers(): {
  ...
  updateUserAutoSlippageMode: (autoSlippageMode: boolean) => void
} {
  const dispatch = useDispatch<AppDispatch>()
  ...
  const updateUserAutoSlippageMode = useCallback(
    (autoSlippageMode: boolean) => {
      dispatch(updateUserAutoSlippageModeAction({ userAutoSlippageMode: autoSlippageMode }))
    },
    [dispatch]
  )

  return { updateCompletedBridgeTransfer, updateUserAutoSlippageMode }
}
