/* eslint-disable */
import { ChainId, Token } from '@voltage-finance/sdk-core'
...
export function useSelectedSwapListUrl(): string | undefined {
  return useSelector<AppState, AppState['lists']['Swap']['selectedListUrl']>(
    (state) => state.lists.Swap.selectedListUrl
  )
}
