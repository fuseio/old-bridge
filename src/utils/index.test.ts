...
import { Token, ChainId, Percent, CurrencyAmount } from '@voltage-finance/sdk-core'
...
describe('utils', () => {
  describe('#getExplorerLink', () => {
    ...
    it('enum', () => {
      expect(getExplorerLink(ChainId.FUSE, 'abc', 'address')).toEqual('https://explorer.fuse.io/address/abc')
    })
  })
